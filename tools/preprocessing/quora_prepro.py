...
def main():
    ...
    outtest = []
    outval = []
    with open("../data/quora_duplicate_questions.tsv", "r") as tsvin:
        # read the tsv file of quora question pairs
        ...
        for row in tsvin:
            ...
            if row[5] == "0" and row[4][-1:] == "?":
                ...
                count1 = count1 + 1
                if (
                    count1 > 1 and count1 < 100002
                ):  # taking the starting 1 lakh pairs as train set.
                    # Change this to 50002 for taking staring 50 k examples as train set
                ...
                # next 30k as the test set acc to https://arxiv.org/pdf/1711.00279.pdf
                elif count1 > 100001 and count1 < 130002:
                    quesid = row[1]
                    ques = row[3]
                    img_id = row[0]
                    ques1 = row[4]
