"""Adapted from https://github.com/eladhoffer/seq2seq.pytorch/blob/master/seq2seq/models/modules/state.py"""
import torch
...
def is_empty(x):
    ...
    if isinstance(x, State):
        return all([is_empty(getattr(x, s)) for s in State.__slots__])
    return False
